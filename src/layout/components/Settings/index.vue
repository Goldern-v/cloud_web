    ...
    >
      <el-scrollbar class="settings-container">
        ...
        <SwitchItem
          ...
          :title="$t('settings.uniqueOpened')"
          @change="handleOtherTheme"
        />
        <SwitchItem
          v-model="theme.isLogo"
          :title="$t('settings.logo')"
          @change="handleOtherTheme"
        />
        <SwitchItem
          v-model="theme.isBreadcrumb"
