...
class Cache {
  ...
  getMonitorSidebar = (): string => {
    return SessionStorage.getItem(CacheKey.monitorPath) || ''
  }

  setMonitorSidebar = (value: string) => {
    SessionStorage.setItem(CacheKey.monitorPath, value)
  }
}
