<template>
  <div class="storage-resource">
    <div class="storage-resource-container">
      <div class="flex-row info-form__tip ideal-middle-margin-bottom">
        ...
        ></svg-icon>
        <span
          >您可以设置该资源池的存储资源配额，控制用户可以申请的资源数量。</span
        >
      </div>
...
const dataArray = ref<any[]>([
  { label: '云硬盘数量（个）', already: '123', quota: '' },
  { label: '云硬盘容量（GB）', already: '123', quota: '' },
  { label: '云硬盘快照数量（个）', already: '123', quota: '' },
  { label: '云硬盘备份-存储库容量（GB）', already: '123', quota: '' },
  { label: '云硬盘备份-备份数量（个）', already: '123', quota: '' },
  { label: '云硬盘备份策略（个）', already: '123', quota: '' },
  { label: '弹性文件服务-文件系统（个）', already: '123', quota: '' },
  { label: '弹性文件服务-文件系统容量（GB）', already: '123', quota: '' }
])
