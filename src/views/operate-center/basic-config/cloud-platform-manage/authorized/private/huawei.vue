  ...
  <div>
    <el-form ref="formRef" :model="form" :rules="rules" label-position="left">
      ...
      <el-form-item label="accesskey" prop="ak">
        <el-input v-model="form.ak" class="custom-input" />
      </el-form-item>

      <el-form-item label="secret" prop="sk">
        <el-input v-model="form.sk" class="custom-input" />
      </el-form-item>
      ...
      <el-form-item label="项目域名" prop="projectDomainName">
        <el-input v-model="form.projectDomainName" class="custom-input" />
      </el-form-item>

      <el-form-item label="用户域名" prop="userDomainName">
        <el-input v-model="form.userDomainName" class="custom-input" />
      </el-form-item>

      <el-form-item label="项目ID">
        <el-input v-model="form.cloudAccount" class="custom-input" />
      </el-form-item>
    </el-form>
