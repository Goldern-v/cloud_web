  ...
  <div class="add-domain">
    <el-form ref="formRef" :model="form" :rules="rules" label-position="left">
      <el-form-item label="域名标识" prop="name">
        <el-input v-model.trim="form.name" placeholder="请输入域名标识" />
      </el-form-item>

      <el-form-item label="域名名称" prop="domainName">
        <el-input v-model.trim="form.domainName" placeholder="请输入域名名称" />
      </el-form-item>
      ...
      <el-form-item label="协议类型" prop="protocol">
        <el-select v-model.trim="form.protocol" placeholder="请选择">
          <el-option
...
const rules = reactive<FormRules>({
  ...
  objectUrl: [
    { required: true, message: '请输入域名访问地址', trigger: 'blur' }
  ],
