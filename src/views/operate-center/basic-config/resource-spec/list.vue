<template>
  <div class="ideal-main-container cloud-host-detail">
...
import SyncList from './sync/list.vue'
import type { TabsPaneContext } from 'element-plus'

// 标签页组件
const tabs: any = { AddList, SyncList }
// tabs标签页
const tabControllers = ref([
  { label: '规格创建', name: 'AddList' },
  { label: '规格同步', name: 'SyncList' }
])
const activeName = ref('AddList')
