<template>
  <div class="all">
    ...
    <div class="flex-row all-header">
      <ideal-button-events
        :left-btns="leftButtons"
        @clickLeftEvent="clickLeftEvent"
      />
      <div class="flex-row all-header-msg">
          ...
          <template #default="props">
            ...
            >
              <div
                ref="contentRef"
                class="all-content"
                :class="{ 'all-content-color': !props.row.readOrNot }"
...
const typeList: any = ref([
  { label: '全部消息', value: '' },
  { label: '财务消息', value: 'FINANCE_MESSAGE' },
  { label: '运维消息', value: 'OPERATION_MESSAGE' },
  { label: '服务消息', value: 'SERVICE_MESSAGE' },
  { label: '产品消息', value: 'PRODUCT_MESSAGE' }
])
