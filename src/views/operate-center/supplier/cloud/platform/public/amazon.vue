<template>
  <div class="amazon">
    <div class="amazon__container">
      <div class="flex-row amazon__tip">
        <svg-icon
          icon="info-warning"
        ...
        ></svg-icon>
        <span
          >请提供亚马逊云访问密钥Access Key信息来进行验证。Access
...
const props = withDefaults(defineProps<AmazonProps>(), {
  cloudCategory: '',
  cloudType: ''
})
