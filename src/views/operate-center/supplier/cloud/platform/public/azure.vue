<template>
  <div class="azure">
    <div class="azure__container">
      <div class="flex-row azure__tip">
        <svg-icon
          icon="info-warning"
        ...
        ></svg-icon>
        <span
          >请提供微软云访问密钥Access Key信息来进行验证。Access
...
const props = withDefaults(defineProps<AzureProps>(), {
  cloudCategory: '',
  cloudType: ''
})
