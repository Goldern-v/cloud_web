<template>
  <div class="zenlayer">
    <div class="zenlayer__container">
      <div class="flex-row zenlayer__tip">
        <svg-icon
          icon="info-warning"
        ...
        ></svg-icon>
        <span
          >为了管理zenlayer平台内的资源，需要您提供zenlayer访问密钥ID、访问密钥和zenlayer地址来访问您的zenlayer。</span
        >
      </div>
