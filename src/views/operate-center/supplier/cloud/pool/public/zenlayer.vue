<template>
  <div class="zenlayerd">
    ...
    >
      ...
      <el-form-item label="VDC" prop="vdcIds">
        <div style="width: 20%">
          <el-tree-select
            v-model="form.vdcIds"
            :data="vdcList"
        ...
        <div class="flex-column" style="width: 100%">
          <div class="flex-row">
            <el-input
              ...
              style="width: 20%"
            ></el-input>
            <div class="zenlayerd--upload" @click="clickUpload">
              上传
...
const rules = reactive<FormRules>({
  ...
  vdcIds: [{ required: true, message: '请选择VDC', trigger: 'blur' }],
