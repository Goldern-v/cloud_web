      ...
      <template v-if="!$slots['control-header']">
          ...
          <el-tooltip effect="light" placement="bottom">
            <template #content>
              <div style="color: #409eff">
                <el-button link @click="downloadProcessAsXml()"
                  >下载为XML文件</el-button
                >
                <!--                <XTextButton-->
                <!--                  title="下载为XML文件"-->
                ...
                <el-button link @click="downloadProcessAsSvg()"
                  >下载为SVG文件</el-button
                >
                <!--                <XTextButton-->
                <!--                  title="下载为SVG文件"-->
                ...
                <el-button link @click="downloadProcessAsBpmn()"
                  >下载为BPMN文件</el-button
                >
                <!--                <XTextButton-->
                <!--                  title="下载为BPMN文件"-->
            ...
            <XButton title="下载文件" pre-icon="download-icon" />
          </el-tooltip>
          <el-tooltip effect="light">
            <XButton pre-icon="browse" title="浏览" />
            <template #content>
        ...
        <ElButtonGroup key="align-control">
          <el-tooltip effect="light" content="向左对齐">
            ...
            /> -->
            <XButton
              pre-icon="format-vertical-align-left"
          ...
          <el-tooltip effect="light" content="向右对齐">
            ...
            /> -->
            <XButton
              pre-icon="format-vertical-align-right"
          ...
          <el-tooltip effect="light" content="向上对齐">
            ...
            /> -->
            <XButton
              pre-icon="format-horizontal-align-top"
              class="align align-left"
              @click="elementsAlign('top')"
            />
          </el-tooltip>
          <el-tooltip effect="light" content="向下对齐">
            ...
            /> -->
            <XButton
              pre-icon="format-horizontal-align-bottom"
              class="align align-right"
              @click="elementsAlign('bottom')"
            />
          </el-tooltip>
        ...
        <ElButtonGroup key="scale-control">
          ...
          <el-tooltip effect="light" content="重置视图并居中">
            ...
            <XButton pre-icon="Vector" @click="processReZoom()" />
          </el-tooltip>
        </ElButtonGroup>
...
import XButton from '@/views/bpm/model/editor/components/XButton/src/XButton.vue'
