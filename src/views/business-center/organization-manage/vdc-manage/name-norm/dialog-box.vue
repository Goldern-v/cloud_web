...
import suffixCreate from './suffix-create.vue'
...
const showSuffixCreate = computed(() => props.type === 'suffix-create')

const initDialog = () => {
  if (showCreate.value) {
    dialogWidth.value = '30%'
    dialogTitle.value = '新建命名规范'
  } else if (isEdit.value) {
    dialogWidth.value = '30%'
    dialogTitle.value = '编辑命名规范'
  } else if (showSuffixCreate.value) {
    dialogWidth.value = '30%'
    dialogTitle.value = '新建命名后缀'
  }
}
// 弹框取消
