<template>
  <div class="ideal-main-container load-balance-monitor">
    <ideal-select-search
...
const tableHeaders: IdealTableColumnHeaders[] = [
  ...
  { label: '运行状态', prop: 'instanceName' },
  { label: '类型', prop: 'instanceName' },
  { label: '服务地址', prop: 'instanceName' },
...
const viewMonitor = () => {
  router.push({
    ...
    query: {
      monitorObject: 'load-balance-monitor'
    }
  })
}
