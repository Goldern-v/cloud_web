...
state.dataList = [
  {
    name: 'router-1219',
    uuid: 'qff009sa00cha8xcs9sc3frg567',
    cpu: '2核',
    memory: '2G',
    networkId: '1sjw4i3qqw821389das9ac',
    publicNetworkId: '2dds87hsa7wc0jww8',
    mirror: 'Ubuntu 18.04',
    ipv4: '10.10.2.2/24',
    shareMode: '全局共享',
...
const toDetail = (row: any) => {
  ...
  router.push({
    path: '/multi-cloud/router-specification/detail',
    query: { detail }
  })
}
...
const clickRefreshEvent = () => {
  ...
  if (dialogType.value === 'resourcePool') {
    router.push({
      path: '/multi-cloud/router-specification/create'
    })
  } else {
    getDataList()
  }
