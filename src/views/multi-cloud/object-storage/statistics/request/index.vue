<template>
  <div class="request">
    ...
    <line-view
      v-for="(item, index) of requestData"
      :key="index"
      ref="chart"
      :item="item"
      :statistics-data="item.statisticsData"
      :statistics-value="item.statisticsValue"
      class="request-chart ideal-middle-margin-top"
    />
  </div>
</template>
...
onMounted(() => {
  requestData.value = [
    { statisticsValue: [], statisticsData: [], cnName: '请求趋势', enName: 'test1', max: 100, min: 2 },
    { statisticsValue: [], statisticsData: [], cnName: '请求次数', enName: 'test2', max: 100, min: 2 },
    { statisticsValue: [], statisticsData: [], cnName: '请求使用率', enName: 'test3', max: 100, min: 2 },
    { statisticsValue: [], statisticsData: [], cnName: '状态码分布', enName: 'test4', max: 100, min: 2 }
  ]
})
/**
