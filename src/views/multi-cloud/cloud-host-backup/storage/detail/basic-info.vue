<template>
  <div class="info">
    ...
    <div class="tag-info ideal-large-margin-top">
      <div>标签</div>
    </div>
      ...
      <el-collapse accordion>
        <el-collapse-item name="1">
          ...
          <div class="flex-row flex-row-center">
            ...
            <div class="ideal-default-margin-right ideal-theme-text">ecs-a14a-volume-0000</div>
            <div>通用型SSD | 40 GiB</div>
            <el-button link type="primary">扩容</el-button>
          </div>
        </el-collapse-item>
        ...
        <el-collapse-item name="2">
          <template #title>
            <div class="flex-row collapse-title flex-row-between">
              <span>策略</span>
              <el-button class="ideal-large-margin-right" link type="primary"
                >绑定备份策略</el-button
              >
            </div>
          </template>
          <div class="flex-row flex-row-between">
            <div>备份策略</div>
            <div>
              defaultPolicy | 启用｜ 每周一、周二、周六的00:00自动执行备份
            </div>
            <div class="flex-row">
...
const labelArray = ref([
  ...
  { label: '数据库备份', prop: 'backup' },
  { label: '开启自动复制', prop: 'autoCopy' },
