<template>
  <div class="create">
    <create-form v-if="stepsIndex === 1" ref="formRef" />
    <create-confirm v-else-if="stepsIndex === 2" :data="orderInfo.form" />

    <div v-else-if="stepsIndex === 3" class="flex-column create-success">
