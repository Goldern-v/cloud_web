<template>
  <div class="local-route">
    ...
    <el-button type="primary" @click="clickLocalRouteCreate">
      <svg-icon
        icon="circle-add"
        color="white"
...
state.dataList = [
  {
    ...
    routeTable: 'rtb-vpc-27d6',
    nextAddress: '192.168.0.11'
  }
]
// 表头
const tableHeaders: IdealTableColumnHeaders[] = [
  { label: '目的地址', prop: 'destination' },
  { label: '路由表', prop: 'routeTable' },
...
// 创建本端路由
const clickLocalRouteCreate = () => {
  showDialog.value = true
  dialogType.value = 'addLocalRoute'
}
// 搜索
