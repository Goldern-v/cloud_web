    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-position="left">
      ...
      <el-card class="ideal-large-margin-top">
        <el-form-item label="选择磁盘">
          <el-radio-group v-model="form.selectDisk" class="ideal-default-margin-right">
            <el-radio-button
        ...
        <el-form-item v-if="form.selectDisk === '1'">
        ...
        <el-form-item label="自动绑定">
          <div>
            ...
            <div v-if="form.autoBind === '1'" class="ideal-tip-text">启用自动绑定功能后，存储库将在下一个备份周期自动扫描并绑定未备份的云硬盘，并开始备份。</div>
          </div>
        </el-form-item>
      </el-card>
      ...
      <el-card class="ideal-large-margin-top">
        <el-form-item label="标签">
          <div style="width: 100%">
            ...
            <div class="flex-row">
              <el-button link type="primary" :disabled="form.tags.length > 10" @click="clickAddTag"
                >添加标签</el-button
              >
              <div>您还可以添加<span>{{ 11 - form.tags.length }}</span>个标签。</div>
            </div>
          </div>
        </el-form-item>
      </el-card>
...
watch(() => form.billingMode, value => {
  emits.emit(EmitsEnum.CDBChangeBillingMode, { billingMode: value })
})
