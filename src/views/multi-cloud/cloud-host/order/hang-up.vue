...
const originalData: any = ref([
  // props.rowData
  { name: 'est1.1', id: '3435335355ssgggfgggefdfdfdf', status: '关机', statusType: 'status-success', mirror: '公共镜像-wew.ffafafhdfudfhufhufhu', spec: '1核 | 1G', createTime: '2023-07-17 17:41:22' }
])
const originalHeader: IdealTableColumnHeaders[] = [
  { label: '名称/ID', prop: 'name', useSlot: true },
  { label: '状态', prop: 'status', useSlot: true },
  { label: '备注', prop: 'mirror' }
]
