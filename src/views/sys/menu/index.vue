<template>
  <el-card class="ideal-main-container mod__menu">
    <el-form :inline="true">
      <el-form-item>
        <el-button
    ...
    >
      ...
      >
        <template #default="scope">
          <svg-icon v-if="scope.row?.icon" :icon="scope.row?.icon"></svg-icon>
        </template>
      </el-table-column>
      <el-table-column
        prop="type"
...
const state: IHooksOptions = reactive({
  dataListUrl: '/iams/sys/menu/list',
  deleteUrl: '/iams/sys/menu',
  isPage: false
})
